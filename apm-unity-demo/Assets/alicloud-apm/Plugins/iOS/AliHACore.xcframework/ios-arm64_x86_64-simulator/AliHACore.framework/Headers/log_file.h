...
namespace instrument {
    ...
    private:
        ...
        void GenerateLogSecretBlock(uint8_t *secret_block_, uint32_t *secret_length);
        ...
        /**
         * write header & secret part
         */
        void WriteLogHeaderAndSecretBlock(FILE *log_file);
        
        void RollingLogFile(std::string log_path, uint32_t bufferd_size);
        
        uint32_t GetLogHeaderAndSecretBlockSize();
        
        uint32_t LE4ToUInt32(const uint8_t bytes[4]) const;
