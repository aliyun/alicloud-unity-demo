...
@class EAPMObjectGraphConfiguration;
...
/**
 ...
 The Graph Element itself can only provide references from EAPMAssociationManager.
 */
@interface EAPMObjectiveCGraphElement : NSObject
...
- (nonnull instancetype)initWithObject:(nullable id)object
                         configuration:(nonnull EAPMObjectGraphConfiguration *)configuration
...
/**
 ...
 (for example ivar names, struct references). For more check EAPMObjectReference protocol.
 */
@property (nonatomic, copy, readonly, nullable) NSArray<NSString *> *namePath;
@property (nonatomic, weak, nullable) id object;
@property (nonatomic, readonly, nonnull) EAPMObjectGraphConfiguration *configuration;
